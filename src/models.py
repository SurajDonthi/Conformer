...
class FeedForward(nn.Module):
    ...
    def __init__(self, input_dim: int = 512, expansion_factor: int = 4, dropout_prob: int = 0.1):
        super().__init__()
        self._layers(input_dim, expansion_factor, dropout_prob)

    def _layers(self, input_dim, expansion_factor, dropout_prob):
